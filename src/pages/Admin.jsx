import ChallengeNameInput from "../components/ChallengeNameInput";

const Admin = () => {
  return (
    <div className="w-full relative bg-white overflow-hidden flex flex-col items-start justify-start pt-0 px-0 pb-[67px] box-border gap-[33px] leading-[normal] tracking-[normal] mq725:gap-4">
